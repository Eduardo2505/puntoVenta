                            ...
                            <div class="col-md-12">
                             <form action="<?php echo site_url('') ?>avaluos/mostrar">
                                <div class="input-group">
                                    ...
                                    &nbsp;
                                    <span class="input-group-btn">   
                                        <a href="<?php echo site_url('') ?>demo/nuevasalidas" class="btn blue">
                                            <i class="fa fa-times"></i> Nueva Salida </a>
                                        </span>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                        <a href="<?php echo site_url('') ?>demo/editarsalidas" title="Ficha" class="btn btn-sm input-circle blue">
